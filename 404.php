...
| -------------------------------------------------------------------------------
| Author            : G-Silvers
| Template Name     : G-Movie V8
| -------------------------------------------------------------------------------
*/
include('header.php'); ?>
<title>G-Silvers Landing Page</title>
<link rel="icon" type="image/jpg" sizes="16x16" href="https://icon-library.com/images/cat-paw-icon/cat-paw-icon-28.jpg">
<style type="text/css">
